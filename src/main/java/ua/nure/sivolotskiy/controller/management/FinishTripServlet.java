...
public class FinishTripServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        trip.setVehicle(vehicleService.getById(Long.valueOf(request.getParameter("vehicleId"))));
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        Booking booking = bookingService.getById(Long.valueOf(request.getParameter("bookingId")));

        vehicle.setId(Long.valueOf(request.getParameter("vehicleId")));
